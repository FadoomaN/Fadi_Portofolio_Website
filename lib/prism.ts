...
// Prism component modules read the core instance from the global scope. Register
// it before invoking the component loader so Vinext cannot reorder grammars ahead
// of the core during production bundling.
...
const prismGrammar: Record<string,string> = { c:'c', cpp:'cpp', 'c++':'cpp', csharp:'csharp', 'c#':'csharp', java:'java', javascript:'javascript', js:'javascript', typescript:'typescript', ts:'typescript', python:'python', sql:'sql', bash:'bash', json:'json', html:'markup', markup:'markup', css:'css', rust:'rust', go:'go' };
